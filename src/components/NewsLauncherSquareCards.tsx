...
const NewsLauncherSquareCards = ({ news }: { news: News[] }) => {
	return <div className="mt-6 p-2 grid auto-rows-fr grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:h-150 gap-2">
...
export default NewsLauncherSquareCards